...
// **************************************************************************
bool test_basic(const data_structures_assignment_2::sequence &test, data_structures_assignment_2::sequence::size_type s,
                bool has_cursor)
{
    bool answer;
...
// **************************************************************************
bool test_items(data_structures_assignment_2::sequence &test, data_structures_assignment_2::sequence::size_type s,
                data_structures_assignment_2::sequence::size_type i, double items[])
{
    bool answer = true;
...
// **************************************************************************
bool correct(data_structures_assignment_2::sequence &test, data_structures_assignment_2::sequence::size_type size,
             data_structures_assignment_2::sequence::size_type cursor_spot, double items[])
{
...
int test1()
{
    data_structures_assignment_2::sequence empty;  // An empty sequence
    data_structures_assignment_2::sequence test;  // A sequence to add items to
...
int test2()
{
    data_structures_assignment_2::sequence test;
    data_structures_assignment_2::sequence::size_type i;
    ...
    std::cout << data_structures_assignment_2::sequence::CAPACITY * 10 << " at the sequence's end." << std::endl;
    for (i = 4; i <= data_structures_assignment_2::sequence::CAPACITY; i++)
        test.attach(i * 10);

    // Test that the sequence is correctly filled.
    std::cout << "Now I will test that the sequence has 10, 20, 30, ...";
    std::cout << data_structures_assignment_2::sequence::CAPACITY * 10 << "." << std::endl;
    test.start();
    for (i = 1; i <= data_structures_assignment_2::sequence::CAPACITY; i++)
    {
...
int test3()
{
    ...
    data_structures_assignment_2::sequence::size_type i;       // for-loop control variable
    ...
    for (i = 0; i < data_structures_assignment_2::sequence::CAPACITY; i++)
        test.insert(0);
    for (i = 0; i < data_structures_assignment_2::sequence::CAPACITY; i++)
        test.remove_current();
    ...
    char_ptr = (char *) &test;
    for (i = 0; i < sizeof(data_structures_assignment_2::sequence); i++)
        if (char_ptr[i] == 'x')
        {
